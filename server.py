...
print(f"🚀 DEBUG: Authentication Code = {auth_code}")
...
def print_server_status():
    print("🚀 DEBUG: Running print_server_status()")
    print("+------------------------------------------------------------+")
    print("|       🚀 SERVER STATUS 🚀                                  |")
    print("+------------------------------------------------------------+")
    ...
    def do_POST(self):
        if self.path == '/send':
            ...
            if name and message and message_id:
                # Allow same message content with unique message_id
